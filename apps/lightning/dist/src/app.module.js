...
const _broswermodule = require("./modules/broswer/broswer.module");
const _applemodule = require("./modules/apple/apple.module");
  ...
  [
    (0, _common.Module)({
      imports: [
        ...
        _broswermodule.BroswerModule.register(),
        _applemodule.AppleModule.register(),
      ],
