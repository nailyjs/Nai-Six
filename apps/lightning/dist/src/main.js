...
(async function bootstrap() {
  ...
  app.setBaseViewsDir((0, _path.join)(process.env.PROJECT_ROOT, "apps/passport/views"));
  ...
  new _ccnailysixshared.CommonLogger("NestApplication").verbose(`Lightning app is running on ${await app.getUrl()}`);
});
