...
(async function bootstrap() {
  ...
  app.setBaseViewsDir(join(process.env.PROJECT_ROOT, "apps/gpt/views"));
  app.useLogger(await app.resolve(CommonLogger));
  app.use(SetNailyAppInfo({ name: "gpt" }));
  ...
  writeFileSync(join(process.env.PROJECT_ROOT, "resources/docs/gpt.json"), JSON.stringify(document));
