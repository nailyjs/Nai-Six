  ...
  return {
    "@nestjs/swagger": {
      models: [
        [
          import("./modules/login/dtos/phone/phone.dto"),
          {
            PostLoginPhoneCodeBodyDTO: {
              phone: { required: true, type: () => String, description: "\u4E2D\u56FD\u5927\u9646\u624B\u673A\u53F7" },
        ...
        [
          import("./modules/login/dtos/email/email.dto"),
          {
        ...
        [
          import("./modules/register/dtos/phone/phone.dto"),
          {
            ...
            PostRegisterEmailCodeBodyDTO: {
              email: { required: true, type: () => String, description: "\u7535\u5B50\u90AE\u4EF6\u5730\u5740" },
              username: {
                required: false,
                type: () => String,
                description: "\u7528\u6237\u540D \u53EF\u9009 \u4E3A\u7A7A\u65F6\u81EA\u52A8\u751F\u6210",
        ...
        [
          import("./modules/user/dtos/user/data.dto"),
          {
            GetUserDataQueryDTO: { key: { required: true, type: () => String, description: "\u83B7\u53D6\u7528\u6237\u6570\u636E\u7684\u952E" } },
            PostUserDataBodyDTO: {
              key: { required: true, type: () => String, description: "\u8BBE\u7F6E\u7528\u6237\u6570\u636E\u7684\u952E" },
              value: { required: true, type: () => String, description: "\u8BBE\u7F6E\u7528\u6237\u6570\u636E\u7684\u503C" },
            },
          },
        ],
        [
          import("./modules/role/dtos/role/role.dto"),
          { GetUserRolePermissionQueryDTO: { roleID: { required: true, type: () => String, description: "\u89D2\u8272ID" } } },
        ],
        [
          import("./modules/pay/dtos/pay/pay.dto"),
          {
            PostUserPayBodyDTO: {
              payType: { required: true, type: () => Object, description: "\u652F\u4ED8\u7C7B\u578B \u8BF7\u770Bschema enum\u518D\u53D6\u503C" },
              amount: {
                required: true,
                type: () => Number,
                description: "\u91D1\u989D \u5355\u4F4D\u5143\uFF0C\u5141\u8BB8\u5C0F\u6570\u70B9\u540E\u4E24\u4F4D",
                minimum: 0.01,
              },
              extraOptions: {
                required: false,
        ...
        [
          import("./modules/pay/dtos/pay/pay.res.dto"),
          {
            PostUserPayDataReceipt201ResDTO: {
              userReceiptID: { required: true, type: () => String, description: "\u6536\u636EID" },
              createdAt: { required: true, type: () => Date, description: "\u521B\u5EFA\u65F6\u95F4" },
              updatedAt: { required: true, type: () => Date, description: "\u66F4\u65B0\u65F6\u95F4" },
              orderID: { required: true, type: () => String, description: "\u8BA2\u5355ID" },
              amount: { required: true, type: () => Number, description: "\u91D1\u989D" },
              userID: { required: true, type: () => String, description: "\u7528\u6237ID" },
              receiptStatus: { required: true, type: () => Object, description: "\u6536\u636E\u72B6\u6001 \u8BF7\u770Bschema\u679A\u4E3E" },
              payType: { required: true, type: () => Object, description: "\u652F\u4ED8\u7C7B\u578B" },
            },
            PostUserPayData201ResDTO: {
              ...
              receipt: {
                required: true,
                type: () => t["./modules/pay/dtos/pay/pay.res.dto"].PostUserPayDataReceipt201ResDTO,
                description:
                  "\u6BCF\u6B21\u8BF7\u6C42\u90FD\u4F1A\u6709\u6536\u636E\u4FE1\u606F\uFF0C\u5305\u62EC\u6536\u636EID\u3001\u521B\u5EFA\u65F6\u95F4\u3001\u66F4\u65B0\u65F6\u95F4\u3001\u8BA2\u5355ID\u3001\u91D1\u989D\u3001\u7528\u6237ID\u3001\u6536\u636E\u72B6\u6001\u3001\u652F\u4ED8\u7C7B\u578B\u7B49\u6570\u636E\u3002\n\n\u4EE5\u540E\u540E\u7AEF\u4F1A\u6DFB\u52A0\u6536\u636E\u68C0\u67E5\u529F\u80FD\uFF1A\u5982\u679Cx\u5C0F\u65F6\u5185\u6CA1\u6709\u652F\u4ED8\u6210\u529F\uFF0C\u5C06\u4F1A\u81EA\u52A8\u5220\u9664\u6389\u6536\u636E\u3002",
              },
            },
            PostUserPay201ResDTO: {
              statusCode: { required: true, type: () => Object, description: "HTTP\u72B6\u6001\u7801", default: 200 },
              code: {
                required: true,
                type: () => Object,
                description:
              ...
              timestamp: { required: true, type: () => Object, description: "\u65F6\u95F4\u6233", default: new Date() },
              data: { required: true, type: () => t["./modules/pay/dtos/pay/pay.res.dto"].PostUserPayData201ResDTO, description: "\u6570\u636E" },
            },
          },
        ],
        [
          import("./modules/pay/dtos/receipt/receipt.dto"),
          {
            GetUserReceiptQueryDTO: {
              orderCreatedAt: {
                required: false,
                description: "\u6839\u636E\u8BA2\u5355\u6392\u5E8F\u65F6\u95F4\u6392\u5E8F",
                enum: t["./modules/pay/enums/order.enum"].CreatedAtEnum,
              },
              orderUpdatedAt: {
                required: false,
                description: "\u6839\u636E\u8BA2\u5355\u66F4\u65B0\u65F6\u95F4\u6392\u5E8F",
                enum: t["./modules/pay/enums/order.enum"].UpdatedAtEnum,
              },
              take: { required: false, type: () => Number, description: "\u83B7\u53D6\u6570\u91CF" },
              skip: { required: false, type: () => Number, description: "\u8DF3\u8FC7\u6570\u91CF" },
            },
      ...
      controllers: [
        ...
        [
          import("./modules/login/controllers/login.controller"),
          {
            LoginController: {
              ...
              loginByEmailCode: { summary: "\u90AE\u7BB1\u9A8C\u8BC1\u7801\u767B\u5F55" },
        ...
        [
          ...
          {
            RegisterController: {
              registerByPhonePassword: { summary: "\u624B\u673A\u53F7\u9A8C\u8BC1\u7801\u6CE8\u518C" },
              registerByEmailPassword: { summary: "\u90AE\u7BB1\u9A8C\u8BC1\u7801\u6CE8\u518C" },
            },
          },
        ],
        [
        ...
        [
          ...
          {
            UserDataController: {
              getUserDataByKey: { summary: "\u83B7\u53D6\u7528\u6237\u6570\u636E" },
              setUserDataByKey: { summary: "\u8BBE\u7F6E/\u66F4\u65B0\u7528\u6237\u6570\u636E" },
              deleteUserDataByKey: { summary: "\u5220\u9664\u7528\u6237\u6570\u636E" },
            },
          },
        ],
        [
          ...
          {
            RoleController: {
              getRoles: { summary: "\u83B7\u53D6\u7528\u6237\u89D2\u8272" },
              getRolePermissions: { summary: "\u83B7\u53D6\u89D2\u8272\u8BE6\u60C5" },
            },
          },
        ],
        [
          import("./modules/role/controllers/permission.controller"),
          { PermissionController: { getPermissions: { summary: "\u83B7\u53D6\u6743\u9650\u5217\u8868" } } },
        ],
        [
          import("./modules/pay/controllers/pay.controller"),
          {
            PayController: {
              pay: { summary: "\u5145\u503C", type: Object },
              notify: { summary: "\u8FC5\u864E\u652F\u4ED8\u56DE\u8C03\u63A5\u53E3", type: String },
            },
          },
        ],
        [
          import("./modules/pay/controllers/receipt.controller"),
          { ReceiptController: { getReceipts: { summary: "\u83B7\u53D6\u5DF2\u767B\u5F55\u7528\u6237\u7684\u6536\u636E\u5217\u8868" } } },
        ],
      ],
    },
  };
