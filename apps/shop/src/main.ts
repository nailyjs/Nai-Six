...
(async function bootstrap() {
  ...
  app.setBaseViewsDir(join(process.env.PROJECT_ROOT, "apps/shop/views"));
  app.useLogger(await app.resolve(CommonLogger));
  app.use(SetNailyAppInfo({ name: "shop" }));
  ...
  writeFileSync(join(process.env.PROJECT_ROOT, "resources/docs/shop.json"), JSON.stringify(document));
  if (enableSwagger)
